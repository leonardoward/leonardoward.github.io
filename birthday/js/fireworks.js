...
var Fireworks = (function() {
  ...
  var poem_array_1 = ["", "1 Universo",
                    "9 Planetas",
                    "204 Países",
                    "809 Islas",
                    "7 Mares"];

  var poem_array_2 = ["", "1 Universo",
                    "9 Planetas",
                    "204 Países",
                    "809 Islas",
                    "7 Mares",
  ...
  var poem_array_3 = ["", "Tú me inspiras tanto", "",
                    "Que cuando pienso en tí",
                    "Me vuelvo poeta"];

  var poem_array_4 = ["", "En este día tan especial te deseo", "",
                    "Que seas muy feliz",
                    "Y tus ojos no dejen de brillar"];

  var poem_array_5 = ["", "Que alcances todas tus metas",
                    "Y cumplas todos tus sueños"];

  var poem_array_6 = ["", "Y que cada día nos deslumbres"];

  var poem_array_7 = ["", "Y que cada día nos deslumbres",
                      "Con tu hermosa sonrisa"];

  var final_poem = [];
  var final_poem_number = 1;
  ...
  function initialize() {
    ...
    window.setInterval(createFirework,4000);
    // window.setInterval(changePoem,5000);
    // and now we set off
    update();
  }
  ...
  function changePoem() {
    if(final_poem_number == 1){
      final_poem = poem_array_1;
      final_poem_number = final_poem_number + 1;
    }else if(final_poem_number == 3){
      final_poem = poem_array_2;
      final_poem_number = final_poem_number + 1;
    }else if(final_poem_number == 5){
      final_poem = poem_array_3;
      final_poem_number = final_poem_number + 1;
    }else if(final_poem_number == 7){
      final_poem = poem_array_4;
      final_poem_number = final_poem_number + 1;
    }else if(final_poem_number == 9){
      final_poem = poem_array_5;
      final_poem_number = final_poem_number + 1;
    }else if(final_poem_number == 11){
      final_poem = poem_array_6;
      final_poem_number = final_poem_number + 1;
    }else if(final_poem_number == 13){
      final_poem = poem_array_7;
      final_poem_number = final_poem_number + 1;
    }else if(final_poem_number == 15){
      final_poem_number = 1;
    }else{
      final_poem_number = final_poem_number + 1;
    }
  ...
  function clearContext() {
    ...
    // mainContext.fillText("Hello World!",10,50);

    // mainContext.font="30px Verdana";
    // Create gradient
    // var gradient = mainContext.createLinearGradient(0,0,0,0);
